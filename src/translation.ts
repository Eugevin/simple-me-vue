export default {
  ...
  pages: {
    index: {
      heading: {
        en: 'Frontend dev with more than 4 years experience in Vue.',
        ru: 'Фронтенд разработчик с более чем 4 годами опыта во Vue.'
      },
      title: {
